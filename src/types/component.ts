 ...
 */
type TExtractDataKitItemFromResult<R> =
     R extends TDataKitResult<infer I>
     ? I
     : R extends { items: (infer I)[] }
     ? I
     : R extends [true, infer Ok]
     ? Ok extends { items: (infer I)[] }
     ? I
     : never
     : never;
 ...
 */
export type TExtractDataKitItemType<T> = T extends (input: TDataKitInput<unknown>) => infer R
 ...
 */
export type TDataKitFilterItem =
     | TDataKitFilterItemText
     | TDataKitFilterItemSelect
     | TDataKitFilterItemBoolean;
