...
// ** ============================================================================
// ** Test Setup: Mock Mongoose Model
// ** ============================================================================
...
describe('Security - Whitelist Strictness', () => {
    ...
    it('should allow fields that are whitelisted', async () => {
        ...
        expect(capturedArgs.name).toEqual(expect.objectContaining({
            $regex: 'John',
            $options: 'i'
        }));
...
// ** ============================================================================
// ** Suite 2: Deep Flawless Check (Runtime Injection)
// ** ============================================================================
...
// ** ============================================================================
// ** Suite 3: Deep Security Hardening (Regex & Proto)
// ** ============================================================================
...
// ** ============================================================================
// ** Suite 4: Basic NoSQL Injection Audit
// ** ============================================================================
...
describe('Security - Basic NoSQL Injection Audit', () => {
    it('should allow NoSQL injection if input is not sanitized', async () => {
        ...
        expect(capturedArgs).not.toEqual(expect.objectContaining({
            secret: { $ne: null }
        }));
